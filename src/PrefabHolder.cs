...
class PrefabHolder
{
    ...
    public static void Preloaded(Dictionary<string, Dictionary<string, GameObject>> preloadedObjects)
    {
        ...
        {
            GameObject tmp = UObject.Instantiate(preloadedObjects["White_Palace_17"]["Cave Spikes Invis"]);
            TinkEffect tmpTe = tmp.GetComponent<TinkEffect>();
        ...
        {
            SceneManager sm = PopSceneManagerPrefab.GetComponent<SceneManager>();
        ...
        PopQuakeFloorPrefab = UObject.Instantiate(preloadedObjects["White_Palace_09"]["Quake Floor"]);
        {
            ...
            Transform t = PopQuakeFloorPrefab.transform.Find("Active");
